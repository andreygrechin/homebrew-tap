...
class Glreporter < Formula
  ...
  homepage "https://github.com/agrechin/glreporter"
  version "0.4.0"
  license "MIT"

  on_macos do
    if Hardware::CPU.intel?
      url "https://github.com/agrechin/glreporter/releases/download/v0.4.0/glreporter_0.4.0_darwin_x86_64.tar.gz"
    ...
    if Hardware::CPU.arm?
      url "https://github.com/agrechin/glreporter/releases/download/v0.4.0/glreporter_0.4.0_darwin_arm64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel? && Hardware::CPU.is_64_bit?
      url "https://github.com/agrechin/glreporter/releases/download/v0.4.0/glreporter_0.4.0_linux_x86_64.tar.gz"
